...
const objA3 = { name: "Pertras" };

const objB = { age: 99 };
const objC = { isMaried: true };

const student = { ...objA, ...objB, ...objC };
console.log(student);

const objAA = { ...objA, ...objA2, ...objA3 };
console.log(objAA);

// jie jau yra reikšmė su raktu ir spredinamas naujas objektas su tokiu pat raktu jis pakeičiamas nauju
